...
namespace Jujialaorenfuwuxitong.Controllers
{
    public class InstitutionController : ApiController
    {
        ...
        public HttpResponseMessage Post(dynamic obj)
        {
            ...
            {
                id = message;
                message = string.Format(@"{{""id"":""{0}"",""name"":""{1}"",""address"":""{2}"",""establishedTime"":""{3}"",""principalPhone"":""{4}"",""isDone"":""{5}"",""uploadTime"":""{6}"",""auditTime"":""{7}"",""photo"":""{8}""}}",
                id, institution.name, institution.address, institution.establishedTime, institution.principalPhone, institution.isDone, institution.uploadTime, institution.auditTime, institution.photo);
